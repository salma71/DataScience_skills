...
- sentiment of sentence of the job description
...
scores <- sentiment_by(m_wide$Job_Description, by=NULL) %>%
  pull(ave_sentiment)
head(scores)

m_wide2 <- m_wide
m_wide2$sentiment <- scores
head(m_wide2 %>% select(Job_Description, sentiment))
